...
Project_1_Advanced_EDA.ipynb
Contains the complete exploratory data analysis, preprocessing, feature engineering, encoding, and validation workflow.

Cleaned_Data_Analytics_Dataset.csv
Contains the final processed dataset generated by the pipeline.
...
One of the biggest lessons from this project was that good machine learning starts with good data.

Before building a model, it is important to understand where the data comes from, identify problems within it, and make thoughtful decisions about how it should be cleaned and transformed.

As my first real Data Science project, this gave me the opportunity to move beyond learning individual concepts and apply them together in a practical workflow.
